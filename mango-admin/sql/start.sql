...
create table `sys_role`(
                           ...
                           `del_flag` tinyint(4) default '0' comment '是否删除  -1：已删除  0：正常',
                           primary key (`id`)
)engine=Innodb auto_increment=34 default charset =utf8 comment ='角色管理';
...
create table `sys_dept`(
                           ...
                           `del_flag` tinyint(4) default '0' comment '是否删除  -1：已删除  0：正常',
                           primary key (`id`)
)engine=Innodb auto_increment=34 default charset =utf8 comment ='机构管理';
...
create table `sys_user_role`(
                                ...
                                `del_flag` tinyint(4) default '0' comment '是否删除  -1：已删除  0：正常',
                                primary key (`id`)
)engine=Innodb auto_increment=34 default charset =utf8 comment ='用户角色';
...
create table `sys_role_menu`(
                                ...
                                `last_update_time` datetime default null comment '更新时间',
                                primary key (`id`)
)engine=Innodb auto_increment=34 default charset =utf8 comment ='角色菜单';
...
create table `sys_role_dept`(
                                ...
                                `last_update_time` datetime default null comment '更新时间',
                                primary key (`id`)
)engine=Innodb auto_increment=34 default charset =utf8 comment ='角色机构';
...
create table `sys_dict`(
                           ...
                           `del_flag` tinyint(4) default '0' comment '是否删除  -1：已删除  0：正常',
                           primary key (`id`)
)engine =Innodb auto_increment=34 default charset =utf8 comment ='数典表';
...
create table `sys_config`(
                             ...
                             `del_flag` tinyint(4) default '0' comment '是否删除  -1：已删除  0：正常',
                             primary key (`id`)
)engine =Innodb auto_increment=34 default charset =utf8 comment ='系统配置表';
...
create table `sys_log`(
                          ...
                          `last_update_time` datetime default null comment '更新时间',
                          primary key (`id`)
)engine =Innodb auto_increment=34 default charset =utf8 comment ='系统日志表';
...
后将online置为login；login：退出登录)',
                                ...
                                `last_update_time` datetime default null comment '更新时间',
                                primary key (`id`)
)engine =Innodb auto_increment=34 default charset =utf8 comment ='系统登录日志表';
